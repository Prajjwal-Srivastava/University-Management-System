...
public:
    ...
    void displayfte()
    {
        ...
        cout<<r7;
        cout<<endl;
        cout<<"\n\t\t "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"          BANSAL INSTITUTE OF TECHNOLOGY"<<endl;
        cout<<"\t\t "<<r6<<" LUCKNOW "<<r6<<"             FOR FACULTY OF ENGINEERING AND TECHNOLOGY,\n";
        cout<<" \t\t "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                        MADE BY:- PRAJJWAL SRIVASTAVA.\n";
        for(int i=0;i<118;i++)
        cout<<r7;
        cout<<endl;
        home();
...
public:
    ...
    void result(string id)
    {
        ...
        for(int i=1;i<66;i++)
            cout<<r5;
            cout<<r4<<endl;
        cout<<"\t"<<r6<<" "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"     BANSAL INSTITUTE OF ENGINEERING AND TECHNOLOGY   "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" LUCKNOW "<<r6<<"       FOR FACULTY OF ENGINEERING AND TECHNOLOGY,      "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                    MADE BY:- PRAJJWAL SRIVASTAVA                  "<<r6<<endl;
        cout<<"\t"<<r6<<"                                                                 "<<r6<<endl;
        ...
        case 0:
            {
                ...
                system("cls");
                cout<<"\n\n\tMADE BY:-"<<endl;
                cout<<"\n\t"<<x<<" PRAJJWAL SRIVASTAVA   18DCS028\n\n\n\n\n";
                getch();
                goto E;
                break;
            }
